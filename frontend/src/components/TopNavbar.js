...
const TopNavbar = () => {
    ...
    const logout = async (e) => {
        try {
            ...
            // console.log(encData);
            // const Key = 'f!1lHm4R0lA_A1b3uRm4cAp7a_abRi31LEL4l0nG(s)p';
            // const decBytes = CryptoJS.AES.decrypt(encData, Key);
            // const decData = decBytes.toString(CryptoJS.enc.Utf8);
            // console.log(decData);
