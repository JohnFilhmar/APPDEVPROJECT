          ...
          {filteredOrders.map((order,index) => (
            <div key={index} className="border-solid border-4 rounded-md border-gray-950">
              <div className="flex justify-between border-solid border-b-4 rounded-md border-gray-950">
                <h2 onClick={() => {console.log(order)}} className="text-md font-bold tracking-tight text-gray-900 dark:text-white">
              ...
              {order.items.map((item) => (
                <>
                  <div key={item.id} className="grid grid-cols-3 h-full text-center p-4">
