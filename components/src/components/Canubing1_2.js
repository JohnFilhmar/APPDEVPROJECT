    ...
    return (
        <>
            <div className="container mx-auto">
                ...
                {/* Canubing 1_2 Branch */}
                <div className="mt-6">
                    <h3 className="text-xl font-semibold mb-2 text-center">Canubing 1_2 Branch</h3>
                ...
                <div className="mt-6">
                    <p className="text-justify ml-4 mr-4 text-center">
                        Here at Canubing 1_2 Branch, we bring the urban motor experience to life. Founded by [Owner's Name] on [Date], our branch in the heart of the city is dedicated to offering a premium selection of motor parts for various leading brands.
                    </p>
                </div>
                ...
                <div className="containerWithBackground"></div>
            </div>
        </>
    );
}
