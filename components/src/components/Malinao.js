    ...
    return (
        <>
            <div className="container mx-auto">
                ...
                {/* Malinao Branch */}
                <div className="mt-6">
                    <h3 className="text-xl font-semibold mb-2 text-center">Malinao Branch</h3>
                ...
                <div className="mt-6">
                    <p className="text-justify ml-4 mr-4 text-center">
                        Here at Malinao Branch, we bring the urban motor experience to life. Founded by [Owner's Name] on [Date], our branch in the heart of the city is dedicated to offering a premium selection of motor parts for various leading brands.
                    </p>
                </div>
